...
if __name__ == "__main__":
    ...
    print("irreps 1", irreps_1)
    print("irreps 2", irreps_2)
    print("irreps 3", irreps_3)
    ...
    print("Dim of irreps1", irreps_1.dim)
    irreps_transform = IrrepsTransform(irreps_1)
    lframes = LFrames(random_rot)
    print("shape of transformed coeffs", irreps_transform(coeffs, lframes).shape)
